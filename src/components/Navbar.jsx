...
export const Navbar = () => {
    ...
    return (
        <header className="flex h-[45px]  w-full bg-white text-slate-800  z-10  fixed top-0  items-center shadow-md py-2 px-4 sm:py-3 sm:px-4 md:px-8 md:py-3 lg:py-4 lg:px-10 sm:h-[50px] md:h-[55px] lg:h-[65px] cursor-pointer">
            <div>
                {/* <h1 onClick={() =>navigate('/')} className="text-3xl font-extrabold hover:cursor-pointer">Buy It</h1> */}
                <img src={logo} alt="logo" className="h-[25px] w-[25px] sm:h-[30px] sm:w-[30px] md:h-[45px] md:w-[45px] lg:h-[50px] lg:w-[50px] " onClick={() => navigate('/')} />
            </div>
